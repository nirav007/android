    ...
    public class Activity1 : Activity
    {
        ...
        protected override void OnCreate (Bundle bundle)
        {
            ...
            button.Click += delegate {
                ...
                var availableActivities = this.PackageManager.QueryIntentActivities (intent, matchDefaultOnly);
                
                // if using Mono for Android 4.1 alpha, integers have been replaced with enums in the API, such as the PackageInfoFlags
                // in the second argument to QueryIntentActivities below
