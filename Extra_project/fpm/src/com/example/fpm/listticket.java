...
public class listticket extends Activity {
	...
	private class AsyncAction extends AsyncTask<String, Void, String> {
		...
		protected void onPostExecute(String result) {
			...
			MyArrayAdapter adapter = new MyArrayAdapter(listticket.this, listArr);
	...
	protected void onResume() {
		...
		} else if (notification.equals("false")) {
	...
	public void filllistdata() {
		...
		result = c.getString(c.link.toString()+"/ticketlist.php?user_id=" + id);
		...
		public View getView(final int position, View convertView,
			...
			btnchkout.setOnClickListener(new OnClickListener() {
				...
				public void onClick(View v) {
					...
					SharedPreferences preferences = PreferenceManager
							.getDefaultSharedPreferences(listticket.this);
