...
public class settingtab extends TabActivity {
   ...
   public void onCreate(Bundle savedInstanceState) {
    ...
    tabHost.setCurrentTab(4);
       ...
       intent = new Intent().setClass(settingtab.this,profile.class);
       ...
       intent = new Intent().setClass(settingtab.this, feedback.class);
       spec = tabHost.newTabSpec("tips").setIndicator(prepareTabView("Feedback"))
       
                     .setContent(intent);
       tabHost.addTab(spec);
       
       intent = new Intent().setClass(settingtab.this, changepassword.class);
