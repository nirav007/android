...
public class settingtab_interest extends TabActivity {
   ...
   public void onCreate(Bundle savedInstanceState) {
    ...
    tabHost.setCurrentTab(4);
       ...
       intent = new Intent().setClass(settingtab_interest.this,profile.class);
       ...
       intent = new Intent().setClass(settingtab_interest.this, feedback.class);
       spec = tabHost.newTabSpec("tips").setIndicator(prepareTabView("Feedback"))
                     .setContent(intent);
       tabHost.addTab(spec);
       
       intent = new Intent().setClass(settingtab_interest.this, interest.class);
