...
public class you extends Activity {
	...
	private void init() {
		...
		Toast.makeText(getApplicationContext(), String.valueOf(user_id).toString(), Toast.LENGTH_LONG).show();
		//count(8);
	...
	public void selectitem()
	{
		 try
		 {
	        	...
	        	HttpPost httpPost = new HttpPost(obS.itemUrl);
	        	List<NameValuePair> nameValue = new ArrayList<NameValuePair>();
	        	nameValue.add(new BasicNameValuePair("user_id"," "+ 7));
	        ...
	        Drawable d  = getResources().getDrawable(R.drawable.desc);
	        ...
	        try{
	        	...
	        	for(int i = 0 ; i <jArray1.length() ; i++)
	        	{
	        		...
	        		//linearLayout.addView(prepareTabView(owner_name,user_name));
	    ...
	    /*
	private View prepareTabView(String text,String uString) {
	    View view = LayoutInflater.from(this).inflate(R.layout.new_you, null);
	   
	    TextView tv = (TextView) view.findViewById(R.id.txt_itemname);
	    //iv.setImageResource(resId);
	    Toast.makeText(getApplicationContext(), text, Toast.LENGTH_LONG).show();
	    tv.setText(text);
	    
	    ImageView img = (ImageView) view.findViewById(R.id.img_item);
	    img.setImageBitmap(getImageBitmap(obS.ImageString+uString));
	    return view;
	}*/
